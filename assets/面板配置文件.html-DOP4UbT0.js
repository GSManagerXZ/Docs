...
<span class="line"><span># 2. 生产环境部署时，请将 CORS_ORIGIN 和 SOCKET_CORS_ORIGIN 设置为实际的前端访问地址</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,5)]))}const d=s(l,[["render",p]]),o=JSON.parse('{"path":"/%E9%83%A8%E7%BD%B2/%E9%9D%A2%E6%9D%BF%E9%85%8D%E7%BD%AE%E6%96%87%E4%BB%B6.html","title":"面板配置文件","lang":"zh-CN","frontmatter":{"title":"面板配置文件","icon":"fa-file-text","order":2,"description":"此问题已于3.3.0版本中在程序运行时会自动检测并生成 .env 文件，无需手动创建。 由于 Github CLI 在自动构建时，会将默认的 .env 文件在上传时删除，所以配置文件需要各位手动上传到面板目录下的 server/ 目录下。 点击这里下载配置文件 注意： 浏览器默认打开会显示内容，使用 Ctrl + S 可以直接保存到面板 server ...","head":[["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"面板配置文件\\",\\"image\\":[\\"\\"],\\"dateModified\\":\\"2025-07-24T04:59:11.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"yxsj245\\",\\"url\\":\\"https://mister-hope.com\\"}]}"],["meta",{"property":"og:url","content":"https://vuepress-theme-hope-docs-demo.netlify.app/%E9%83%A8%E7%BD%B2/%E9%9D%A2%E6%9D%BF%E9%85%8D%E7%BD%AE%E6%96%87%E4%BB%B6.html"}],["meta",{"property":"og:site_name","content":"GSManager"}],["meta",{"property":"og:title","content":"面板配置文件"}],["meta",{"property":"og:description","content":"此问题已于3.3.0版本中在程序运行时会自动检测并生成 .env 文件，无需手动创建。 由于 Github CLI 在自动构建时，会将默认的 .env 文件在上传时删除，所以配置文件需要各位手动上传到面板目录下的 server/ 目录下。 点击这里下载配置文件 注意： 浏览器默认打开会显示内容，使用 Ctrl + S 可以直接保存到面板 server ..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2025-07-24T04:59:11.000Z"}],["meta",{"property":"article:modified_time","content":"2025-07-24T04:59:11.000Z"}]]},"git":{"createdTime":1753280788000,"updatedTime":1753333151000,"contributors":[{"name":"小朱","username":"","email":"10714957+xiao-zhu245@user.noreply.gitee.com","commits":2}]},"readingTime":{"minutes":1.07,"words":321},"filePathRelative":"部署/面板配置文件.md","autoDesc":true}');export{d as comp,o as data};
