...
<span class="line"><span>REQUEST_TIMEOUT=30000</span></span>
<span class="line"><span></span></span>
<span class="line"><span># 说明：</span></span>
<span class="line"><span># 1. 修改 SERVER_PORT 可以更改后端服务端口</span></span>
<span class="line"><span># 2. 生产环境部署时，请将 CORS_ORIGIN 和 SOCKET_CORS_ORIGIN 设置为实际的前端访问地址</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,4)]))}const d=s(l,[["render",p]]),o=JSON.parse('{"path":"/%E9%83%A8%E7%BD%B2/%E9%9D%A2%E6%9D%BF%E9%85%8D%E7%BD%AE%E6%96%87%E4%BB%B6.html","title":"面板配置文件","lang":"zh-CN","frontmatter":{"title":"面板配置文件","icon":"fa-file-text","order":2,"description":"由于 Github CLI 在自动构建时，会将默认的 .env 文件在上传时删除，所以配置文件需要各位手动上传到面板目录下的 server/ 目录下。 点击这里下载配置文件 注意： 浏览器默认打开会显示内容，使用 Ctrl + S 可以直接保存到面板 server 目录下。 您也可以复制下方配置文件内容，手动创建 .env 文件。","head":[["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"面板配置文件\\",\\"image\\":[\\"\\"],\\"dateModified\\":\\"2025-07-23T14:26:28.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"yxsj245\\",\\"url\\":\\"https://mister-hope.com\\"}]}"],["meta",{"property":"og:url","content":"https://vuepress-theme-hope-docs-demo.netlify.app/%E9%83%A8%E7%BD%B2/%E9%9D%A2%E6%9D%BF%E9%85%8D%E7%BD%AE%E6%96%87%E4%BB%B6.html"}],["meta",{"property":"og:site_name","content":"GSManager"}],["meta",{"property":"og:title","content":"面板配置文件"}],["meta",{"property":"og:description","content":"由于 Github CLI 在自动构建时，会将默认的 .env 文件在上传时删除，所以配置文件需要各位手动上传到面板目录下的 server/ 目录下。 点击这里下载配置文件 注意： 浏览器默认打开会显示内容，使用 Ctrl + S 可以直接保存到面板 server 目录下。 您也可以复制下方配置文件内容，手动创建 .env 文件。"}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2025-07-23T14:26:28.000Z"}],["meta",{"property":"article:modified_time","content":"2025-07-23T14:26:28.000Z"}]]},"git":{"createdTime":1753280788000,"updatedTime":1753280788000,"contributors":[{"name":"小朱","username":"","email":"10714957+xiao-zhu245@user.noreply.gitee.com","commits":1}]},"readingTime":{"minutes":0.96,"words":289},"filePathRelative":"部署/面板配置文件.md","autoDesc":true}');export{d as comp,o as data};
