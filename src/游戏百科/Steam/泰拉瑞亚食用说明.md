...
1. 从官网"https://terraria.fandom.com/wiki/Server#Downloads"下载，选择与自己相符的服务端匹配的版本。
   ...
   ![下载页面](https://images.xiaozhuhouses.asia:3000/i/2025/07/27/ua5snm.png)
...
2. 在面板文件管理中找一个合适的地方，把解压包上传上去。
   ...
   ![上传文件](https://images.xiaozhuhouses.asia:3000/i/2025/07/27/uf1x9h.png)
...
3. 解压后，找到TerrariaServer.bin.x86_64 和 TerrariaServer.bin.x86 分别对应64位和32位
   ...
   ![解压文件](https://images.xiaozhuhouses.asia:3000/i/2025/07/27/ujq3z9.png)
