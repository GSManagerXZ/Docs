...
1. 打开面板找到未转变者点击安装
   ...
   ![安装游戏](https://images.xiaozhuhouses.asia/i/2025/10/24/x9cq6a.png)

2. 安装后，在启动参数中填写 `ExampleServer.sh` 生成服务端配置文件

   ![启动参数](https://images.xiaozhuhouses.asia/i/2025/10/24/xckkho.png)

3. 控制台输出一下指令，输入 `shutdown` 退出即可

   ![控制台指令](https://images.xiaozhuhouses.asia/i/2025/10/24/xdlyfc.png)

这个时候，在 `~/U3DS/Servers` 目录下，就会出现 `/Myserver` 目录，以下是目录结构。

![目录结构](https://images.xiaozhuhouses.asia/i/2025/10/24/xg1l5d.png)
...
![Steam 令牌管理](https://images.xiaozhuhouses.asia/i/2025/10/24/xhxlfa.png)
...
![Config.json 文件](https://images.xiaozhuhouses.asia/i/2025/10/24/xj305o.png)

对于不想启动 BattlEye 防作弊的，修改如下配置项：

![关闭 BattlEye 防作弊](https://images.xiaozhuhouses.asia/i/2025/10/24/xj34q4.png)
